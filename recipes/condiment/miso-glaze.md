...
season:
  - all-year
prep_time: "5 min [ACTIVE]"
cook_time: "5 min [ACTIVE]"
inactive_time: "5 min [PASSIVE]"
total_time: "15 min"
base_servings: 1
serving_unit: "cup"
...
> [!NOTE] Origin
> Created from title-only addendum; based on versatile miso glaze technique.
...
### Cook's Notes
- Simmering the miso blend too long or at too high a heat can cause it to separate or become grainy; keep the heat low and stir constantly.
- The glaze is versatile: use it as a marinade (apply 30 minutes before cooking), a glaze (apply during cooking), or a finishing drizzle.
