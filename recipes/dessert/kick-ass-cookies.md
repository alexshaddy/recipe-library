---
title: "Kick-Ass Cookies"
aliases: []
slug: kick-ass-cookies
meal_type:
  - dessert
cuisine:
  - american
...
cook_time: "12 min"
inactive_time: "1 hr"
total_time: "1 hr 32 min"
base_servings: 24
serving_unit: "cookies"
scaling_notes: "The recipe scales linearly; maintain the ratio of 2 parts flour to 1 part butter to 1 part sugar. When doubling, use a larger mixing bowl and consider chilling the dough in batches if space is limited."
source_type: "handwritten"
source_name: "Chef's Recipe Notebook"
source_url: ""
source_page: "15"
origin_notes: "Notebook cookie note with a playful title. Classic butter cookie with crisp edges and chewy centers."
difficulty: "easy"
key_equipment:
  - sheet-pan
  - electric-mixer
...
> [!NOTE] Origin
> Best-effort transcription from notebook page 15. Classic butter cookies with crisp edges and chewy centers — the secret is chilling the dough.
...
1. **Cream Butter and Sugar.** In a large mixing bowl, beat 1 cup softened butter and 1 cup granulated sugar together with an electric mixer on medium speed until the mixture is pale yellow, light, and fluffy (~3–4 min). The volume should visibly increase, and the texture should resemble soft whipped cream.
...
7. **Bake.** Place the sheet in the center of the oven and bake until the edges are golden brown and set, but the centers still look soft and slightly underdone (~10–12 min). The cookies will continue to cook on the hot sheet.
...
### Cook's Notes
- Chilling the dough is not optional; it allows the flour to hydrate fully and prevents excessive spreading, resulting in thicker, chewier cookies.
- For an extra depth of flavor, substitute half the granulated sugar with packed light brown sugar and increase vanilla to 1 1/2 teaspoons.

### Variations
- **Chocolate Chip Kick-Ass Cookies:** Fold in 1 cup semi-sweet chocolate chips after mixing the dry ingredients in step 4.
...
*Source: Chef's Recipe Notebook, p.15 · Added: 2026-06-26*