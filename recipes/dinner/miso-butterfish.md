...
season:
  - all-year
prep_time: "15 min [ACTIVE]"
cook_time: "10 min [ACTIVE]"
inactive_time: "48 hr [INACTIVE]"
total_time: "48 hr 25 min"
base_servings: 4
...
> [!NOTE] Origin
> Created from title-only addendum; based on Nobu-style saikyo-yaki technique.

## Ingredients

*Base servings: 4 fillets*
...
4. **Remove Excess Marinade** – Take** of the refrigerator. Gently wipe off the fish out of the refrigerator. Gently wipe off most of the miso marinade with your fingers or a paper towel, leaving only a very thin layer (the marinade will burn if too thick). Discard used marinade.
...
### Cook's Notes
- Wiping off excess marinade before broiling prevents burning and allows the sugar to caramelize without charring.
- Saikyo miso is traditionally used for its sweetness; if using regular white miso, you may need to add a bit more sugar.
