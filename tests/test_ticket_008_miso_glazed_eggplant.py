...
RECIPE_PATH = os.path.join(RECIPE_DIR, "dinner/miso-glazed-eggplant.md")
"""
...
def main():
    ...
    tests = [
        ...
        ("Instructions: 6-8 steps", lambda: test_instructions_step_count(content)),
        ("Instructions: bolded action titles", lambda: test_instructions_bolded_titles(content)),
